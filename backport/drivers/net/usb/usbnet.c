...
bp_usbnet_netdev_ops_dev_get_tstats64(struct net_device *dev,
...
static void bp_usbnet_netdev_ops_usbnet_tx_timeout(struct net_device *dev){
...
#else
	.ndo_tx_timeout = bp_usbnet_netdev_ops_usbnet_tx_timeout,
#endif
...
#else
	.ndo_get_stats64 = bp_usbnet_netdev_ops_dev_get_tstats64,
#endif
