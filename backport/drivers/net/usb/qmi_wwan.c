...
bp_qmimux_netdev_ops_dev_get_tstats64(struct net_device *dev,
...
#else
	.ndo_get_stats64 = bp_qmimux_netdev_ops_dev_get_tstats64,
#endif
...
#if LINUX_VERSION_IS_LESS(4,11,0)
static struct rtnl_link_stats64 *
bp_qmi_wwan_netdev_ops_dev_get_tstats64(struct net_device *dev,
					struct rtnl_link_stats64 *stats){
	dev_get_tstats64(dev, stats);
	return stats;
}
...
static void bp_qmi_wwan_netdev_ops_usbnet_tx_timeout(struct net_device *dev){
...
static const struct net_device_ops qmi_wwan_netdev_ops = {
...
#else
	.ndo_tx_timeout = bp_qmi_wwan_netdev_ops_usbnet_tx_timeout,
#endif
	...
	.ndo_get_stats64	= dev_get_tstats64,
#else
	.ndo_get_stats64 = bp_qmi_wwan_netdev_ops_dev_get_tstats64,
#endif
