...
bp_sierra_net_device_ops_dev_get_tstats64(struct net_device *dev,
...
static void bp_sierra_net_device_ops_usbnet_tx_timeout(struct net_device *dev){
...
#else
	.ndo_tx_timeout = bp_sierra_net_device_ops_usbnet_tx_timeout,
#endif
...
#else
	.ndo_get_stats64 = bp_sierra_net_device_ops_dev_get_tstats64,
#endif
