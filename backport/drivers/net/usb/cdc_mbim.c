...
bp_cdc_mbim_netdev_ops_dev_get_tstats64(struct net_device *dev,
...
static void bp_cdc_mbim_netdev_ops_usbnet_tx_timeout(struct net_device *dev){
...
#else
	.ndo_tx_timeout = bp_cdc_mbim_netdev_ops_usbnet_tx_timeout,
#endif

#if LINUX_VERSION_IS_GEQ(4,11,0)
	.ndo_get_stats64      = dev_get_tstats64,
#else
	.ndo_get_stats64 = bp_cdc_mbim_netdev_ops_dev_get_tstats64,
#endif
